-- FUTURE AUTOMOTIVE - PAN Issues Table
-- جدول مشاكل PAN للنظام

-- Create pan_issues table if it doesn't exist
...
-- Insert sample PAN issues if table is empty
...
-- Show results
SELECT 
    'PAN Issues table created successfully' as status,
    (SELECT COUNT(*) as count FROM pan_issues) as total_issues,
    'Ready for use with breakdown reports' as message;
