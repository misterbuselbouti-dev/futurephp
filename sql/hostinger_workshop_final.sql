-- FUTURE AUTOMOTIVE - Workshop Management Tables for Hostinger (Final Version)
-- إنشاء جداول إدارة الورشة لبيئة Hostinger - نسخة نهائية

-- Step 1: Create work_orders table with indexes included
...
-- Step 2: Create work_order_parts table with indexes included
...
-- Step 3: Create work_order_timeline table with indexes included
