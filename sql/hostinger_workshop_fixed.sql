-- FUTURE AUTOMOTIVE - Workshop Management Tables for Hostinger (Fixed)
-- إنشاء جداول إدارة الورشة لبيئة Hostinger - نسخة مصححة
...
ALTER TABLE work_orders ADD INDEX IF NOT EXISTS idx_ref_ot (ref_ot);
ALTER TABLE work_orders ADD INDEX IF NOT EXISTS idx_bus_id (bus_id);
ALTER TABLE work_orders ADD INDEX IF NOT EXISTS idx_technician_id (technician_id);
ALTER TABLE work_orders ADD INDEX IF NOT EXISTS idx_status (status);
ALTER TABLE work_orders ADD INDEX IF NOT EXISTS idx_priority (priority);
ALTER TABLE work_orders ADD INDEX IF NOT EXISTS idx_created_at (created_at);
...
-- Add indexes for work_order_parts
ALTER TABLE work_order_parts ADD INDEX IF NOT EXISTS idx_work_order_id (work_order_id);
ALTER TABLE work_order_parts ADD INDEX IF NOT EXISTS idx_ref_article (ref_article);
...
-- Add indexes for work_order_timeline
ALTER TABLE work_order_timeline ADD INDEX IF NOT EXISTS idx_work_order_id (work_order_id);
ALTER TABLE work_order_timeline ADD INDEX IF NOT EXISTS idx_performed_at (performed_at);
...
-- Success message
SELECT '✅ Workshop tables created successfully for Hostinger!' as status,
