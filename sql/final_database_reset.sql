-- FUTURE AUTOMOTIVE - Final Database Reset Solution
-- Use MySQL CLI to force reset the database

-- INSTRUCTIONS:
-- 1. Open Command Prompt/Terminal
-- 2. Navigate to your XAMPP directory
-- 3. Run: mysql -u root -p
-- 4. Run these commands one by one in MySQL CLI
...
-- Step 3: Drop all tables (run each command separately)
...
-- Step 4: Drop any other tables that might exist
...
-- Step 10: Create breakdown_reports table
...
-- Step 11: Create breakdown_assignments table
...
-- Step 12: Create breakdown_work_items table
...
-- Step 13: Create breakdown_time_logs table
...
-- Step 14: Create breakdown_audit_log table
...
-- Success message
SELECT '✅ Final database reset completed successfully!' as message;
