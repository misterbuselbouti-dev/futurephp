-- FUTURE AUTOMOTIVE - Manual Database Reset
-- Step by step manual reset instructions

-- First, run these commands individually in phpMyAdmin SQL tab:

-- Step 1: Disable foreign key checks
SET FOREIGN_KEY_CHECKS = 0;

-- Step 2: Drop tables one by one (run each command separately)
...
-- Step 8: Create articles_catalogue table
...
-- Step 9: Create breakdown_reports table
...
-- Step 10: Create breakdown_assignments table
...
-- Step 11: Create breakdown_work_items table
...
-- Step 12: Create breakdown_time_logs table
...
-- Step 13: Create breakdown_audit_log table
...
-- Success message
SELECT '✅ Manual database reset completed successfully!' as message;
