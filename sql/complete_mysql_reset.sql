-- FUTURE AUTOMOTIVE - Complete Database Reset with MySQL CLI
-- Run this file using MySQL CLI directly

-- INSTRUCTIONS:
-- 1. Open Command Prompt/Terminal
-- 2. Navigate to XAMPP MySQL bin directory
-- 3. Run: mysql -u root -p
-- 4. Copy and paste this entire file content into MySQL CLI
...
-- Step 3: Drop all tables (run these commands one by one)
