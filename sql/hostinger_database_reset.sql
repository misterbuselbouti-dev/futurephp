-- FUTURE AUTOMOTIVE - Hostinger Database Reset
-- Special configuration for Hostinger hosting
...
-- Success message
SELECT '✅ Hostinger database reset completed successfully!' as message;
