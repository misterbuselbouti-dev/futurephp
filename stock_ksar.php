<?php
// FUTURE AUTOMOTIVE - Stock Ksar-Larache (page indépendante)
require_once 'config.php';
require_login();
$region_code = 'ksar';
$region_name = 'Ksar-Larache';
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .stock-card .card-header { background: #dcfce7; color: #166534; font-weight: 600; padding: 1rem 1.25rem; }
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                ...
                <a href="articles_stockables.php" class="btn btn-outline-success"><i class="fas fa-arrow-left me-1"></i>Retour aux articles</a>
            </div>
        ...
        function render(rows) {
            ...
            tbody.innerHTML = rows.map(a => `
                <tr>
                    ...
                    <td>
                        <button class="btn btn-sm btn-success" onclick="saveOne(${a.id}, this)">Enregistrer</button>
                    </td>
                </tr>
            `).join('');
        }
