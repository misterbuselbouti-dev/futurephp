            ...
            <section class="dashboard-section">
                ...
                <div class="stats-row">
                    <div class="stat-box">
                        ...
                        <a href="buses_complete.php" class="btn btn-sm btn-outline-primary mt-2">Voir tout</a>
                    </div>
                    <div class="stat-box">
                        ...
                        <a href="drivers.php" class="btn btn-sm btn-outline-primary mt-2">Voir tout</a>
                    </div>
                    <div class="stat-box">
                        ...
                        <a href="articles_stockables.php" class="btn btn-sm btn-outline-primary mt-2">Voir tout</a>
                    </div>
                    <div class="stat-box">
                        ...
                        <a href="admin_breakdowns.php" class="btn btn-sm btn-outline-primary mt-2">Voir tout</a>
                    </div>
                    <div class="stat-box">
